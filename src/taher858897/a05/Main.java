...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ImageMultithread imageMultithread = new ImageMultithread(8, image, s, width/2, width,0, height);
        try {

            ImageMultithreadSocketWriter writer = new ImageMultithreadSocketWriter("saeftaher.de", 8770, image, s,0, width/2,0, height);
            ...
            image.initLocks();
            image.merge(writer.RESULT_IMG,0, width/2,0, height);
